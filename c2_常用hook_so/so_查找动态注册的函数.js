...
/*
    通过hook libart.so中的RegisterNative函数，
*/
...
function attach(addr) {
    Interceptor.attach(addr, {
        ...
        onLeave: function (retval) {
            var need_filter = true;  //当输出太多时，选择是否需要过滤
            var target_module = "libdusanwa.so";
            var target_method = "intercept";
