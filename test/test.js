...
function tools() {
    Java.perform(function () {
        ...
        NativeCrypto.SSL_do_handshake.implementation = function (sslNativePointer, fd, shc, timeoutMillis) {
            console.log("hooking");
            //实现接口：com.android.org.conscrypt.NativeCrypto$SSLHandshakeCallbacks
            console.log(shc.$className); //com.android.org.conscrypt.NativeCrypto
            return this.SSL_do_handshake.apply(this, arguments);
        }*/


        /*let Platform = Java.use("com.android.org.conscrypt.Platform");
        Platform.checkServerTrusted.overload('javax.net.ssl.X509TrustManager', '[Ljava.security.cert.X509Certificate;', 'java.lang.String', 'com.android.org.conscrypt.AbstractConscryptSocket')
            ...
            console.log("hooking");
             //实现接口：javax.net.ssl.X509TrustManager
            console.log(tm.$className); //实现类：android.security.net.config.RootTrustManager
...
function hook1() {
    Java.perform(function () {
        ...
        /*Java.use("java.io.File").$init.overload('java.io.File', 'java.lang.String').implementation = function (file, cert) {
            ...
            if (cert.indexOf("cacert") >= 0 || file.getPath().indexOf("cacert") >= 0 || stack.indexOf("X509TrustManagerExtensions") >= 0 || stack.indexOf("checkServerTrusted") >= 0) {
                console.log("1-find ", "SSLpinning position locator => " + file.getPath() + " " + cert);
                console.log(stack);
            }
        ...
        Java.use("java.io.File").$init.overload('java.lang.String').implementation = function (cert) {
            ...
            var stack = Java.use("android.util.Log").getStackTraceString(Java.use("java.lang.Throwable").$new());
            if (cert.indexOf("cacert") >= 0 || stack.indexOf("X509TrustManagerExtensions") >= 0 || stack.indexOf("checkServerTrusted") >= 0) {
                console.log("2-find ", "SSLpinning position locator => " + cert);
                console.log(stack);
            }
...
var Pinning_DroidSSLUnpinning = function () {
    ...
    Java.perform(function () {
        ...
        */
        ...
        // TODO Implement a new TrustManager
        ...
        */
        ...
        //TODO httpclientandroidlib Hooks
        try {
        ...
        // TODO android 7.0+ network_security_config TrustManagerImpl hook。 apache httpclient partly
...
setImmediate(hook2)
//setImmediate(Pinning_DroidSSLUnpinning)